...
router.get("/me", checkAuth(Role.MEMBER, Role.ADMIN, Role.SUPER_ADMIN), AuthController.getMe);
router.get("/get-session", checkAuth(Role.MEMBER, Role.ADMIN, Role.SUPER_ADMIN), AuthController.getSession);
